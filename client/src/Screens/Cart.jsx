...
export default function Cart() {
  ...
  //   if(userEmail===null){
  //     alert('Login Again Session Timed out');
  //   }
  //   try {
  ...
  //     // Handle any error during the checkout process here
  //   }
  //   console.log("ok");
  // };
          ...
          <tbody>
            {data.map((food, index) => (
              <tr>
                ...
                <td>{food.size}</td>
                <td>{food.price}</td>
                <td ><button type="button" className="btn p-0" onClick={() => { dispatch({ type: "REMOVE", index: index }) }} ><AiFillDelete/></button> </td></tr>
            ))}
          </tbody>
        </table>
